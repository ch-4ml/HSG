package com.hsg.intro.emp.ntc.controller;
...
public class EmpNtcController {
	...
	// 데이터 ajax call
	@RequestMapping(value = "get.en", produces = "application/json;charset=utf8") // DI 의존성 주입
	...
	// contents 검색
	@RequestMapping(value = "find.en", method = RequestMethod.GET) // DI 의존성 주입
	public ModelAndView find(
		...
		try {
			...
			mv.setViewName("redirect:view.en");
		} catch (ContentsException e) {
	...
	// contents 추가 폼
	@RequestMapping(value = "insertView.en", method = RequestMethod.GET) // DI 의존성 주입
	public ModelAndView insertView(ModelAndView mv) {
		
		mv.setViewName("emp/ntc/emp_ntc_00002");
		return mv;
	}
	
	// contents 추가
	@RequestMapping(value = "insert.en", method = RequestMethod.POST) // DI 의존성 주입 
	...
	// contents 수정
	@RequestMapping(value = "update.en", method = RequestMethod.POST) // DI 의존성 주입
	...
	// contents 삭제 
	@RequestMapping(value = "delete.en", method = RequestMethod.GET) // DI 의존성 주입
	...
	@RequestMapping(value="download.en")
