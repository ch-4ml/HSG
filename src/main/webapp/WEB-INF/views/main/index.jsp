...
$(function() {
	$("#updateGreButton").click(function() {
		...
		$("#updateGreSection").html("<textarea id='contents' name='contents'>" + oldImage + oldContent + "</textarea><br><div style='text-align:center;'><input type='submit' value='수정'></div>");
		tinymce.init({
...
$(function() {
	$("#updateMoocButton").click(function() {
		...
		$("#updateMoocSection").html("<textarea id='contents' name='contents'>" + oldImage + oldContent + "</textarea><br><div style='text-align:center;'><input type='submit' value='수정'></div>");
		tinymce.init({
		    selector: 'textarea#contents',
		    menubar: false,
		    language_url: 'tinymce/ko_KR.js',
