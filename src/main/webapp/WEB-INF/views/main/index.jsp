...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-feature text-center item-padding wow fadeInUp"
						data-wow-delay="250ms">
						<img src="./resources/images/feature1.png" alt="">
						<h3>교육 솔루션</h3>
						<p class="pt-3">기업에 근무하는 R&D 인력을 대상으로 신규 프로젝트 진행이나, 개발자의 직무향상을
							위하여 기업이 컨설팅 및 교육을 위탁하여 진행되는 서비스입니다.</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div
						class="single-feature text-center item-padding mt-4 mt-md-0 wow fadeInUp"
						data-wow-delay="500ms">
						<img src="./resources/images/feature3.png" alt="">
						<h3>개발</h3>
						<p class="pt-3">
							산업용 pc 기반의 사용자 인터페이스 프로그램과 교육용 Kocoafab 지니어스키트 스타터 팩 및 보드 등을
							개발합니다.<br>
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div
						class="single-feature text-center item-padding mt-4 mt-lg-0 wow fadeInUp"
			...
			<div class="row wow fadeIn" data-wow-delay="500ms">
				...
				<div class="col-lg-7">
					<div class="welcome-text mt-5 mt-lg-0">
						...
						<p class="pt-3">HS글로벌은 하드웨어와 소프트웨어를 융합하는 혁신적인 시스템 개발의 목적을 가지고
							설립되었습니다. 현업에서 풍부한 노하우를 가지고 있는 훌륭한 엔지니어들이 모여 융합 시스템 연구 및 개발을 적극적으로
							진행하고 있으며 산업 현장에 실무 노하우를 전달하는 역할에도 최선을 다하고 있습니다.</p>
						<p>HS글로벌은 하드웨어/소프트웨어 융합 시스템 솔루션 전문 기업으로 시작하여 미래 글로벌 IT 융합 기업을
							목표로 힘차게 나아가겠습니다. 고객, 엔지니어, 직원이 모두 행복한 회사가 될 것을 약속드리며 앞으로도 저희
							HS글로벌에 변함없는 관심과 성원을 부탁드립니다.</p>
	...
	<section class="mooc-area section-padding3">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 align-self-center wow fadeInUp"
					data-wow-delay="250ms">
					<div
						style="position: relative; max-width: 100%; padding-bottom: 75%; height: 0;">
						<iframe width="320" height="240"
							src="https://www.youtube.com/embed/4dW_X4fDPqg" frameborder="0"
							allowfullscreen=""
							style="position: absolute; position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
					</div>
				</div>
				<div class="col-lg-7 wow fadeInUp" data-wow-delay="500ms">
					<div class="youtube-text mt-5 mt-lg-0">
						<p class="pt-1">SW교육 솔루션 '스마트메이커‘ 를 문제해결능력 교육 관점에서 설명을 해
							놓았습니다. 강력한 휴대용컴퓨터라고 할 수 있는 스마트폰을, 모든 사람이 한 대씩 항시 소지하고 다니면서, 사용하는
							모바일시대가 도래하면서, 지구촌의 거의 모든 나라에서 소프트웨어를 의무교육으로 가르치고 있습니다. 오늘날, 모든
							학생을 대상으로 하는 소프트웨어 보편교육의 목적은, 이전에 소수 전문 프로그래머 양성을 위해서, 실시해온 코딩 교육이
							아닙니다. 코딩은, 더 이상 적합한 교육의 대상도, 방법도 아니라고 할 수 있습니다. 소프트웨어 보편교육 목적은,
							우리 일상생활의 문제를 해결하는 능력을 배양하는 것 입니다. 하지만, 프로그래밍 코딩 기술을 배우지 않고는,
							문제해결능력을 배양하는 수업을 할 수 있는 교육용 솔루션이 없었다는 것이, 사실입니다. 그러나 A. I. 기술로
							만들어진 '스마트메이커'를 활용하면, 더 이상 코딩이나 알고리즘과 같이, 세상 문제와는 아무런 상관도 없고, 컴퓨팅
							장치 밖에서는 전혀 써먹지도 못할 교육을 학생들에게 시킬 필요가 없습니다. 앞으로 학생들이 실제로 풀어야 할 사회
							문제나, 현실 문제에 집중해서 조사 및 분석하는 과정을 통해, 생각하는 힘을 기르고 그런 문제를 해결할 도구로서,
							소프트웨어를 만드는 지식과 경험을 체득할 수 있게 됩니다</p>
					</div>
				</div>
			</div>
	</section>
